            ...
            {isComplete && showVisualizer && category ? (
              ...
              <>
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <button
                    onClick={() => isComplete && setShowVisualizer(true)}
                    disabled={!isComplete}
                    title={isComplete ? 'Preview your product in 3D' : 'Complete your spec to preview'}
                    className="flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-semibold transition disabled:cursor-not-allowed disabled:opacity-40 bg-brand-600 text-white hover:bg-brand-700 disabled:hover:bg-brand-600"
                  >
